...
class SeasonCalculator:
    ...
    def __init__(self, today, season_dates_file):
        self.seasons = []
        self.season_dates = {}
        self.year_to_season = {}
        self.today = today
    ...
    def read_season_dates(self, season_dates_file):
    ...
    def get_season_from_date(self, date):
        ...
        for season in potential_seasons:
            ...
            if date_timestamp >= curr_season_dates[0] and date_timestamp <= curr_season_dates[2]: # date happened during this season (including offseason)
                if date_timestamp <= curr_season_dates[1]: # date happened in season proper
                    return season, True
